...
step 1. run the sort method on the input array
step 2. define sorting callback function that sorts a-b
step 3. dont forget to access length of childrens array a.children.length
step 4. if they have same number, can use if else or ? ternary , in ternary look at house property sort a-b
------------------------------------------------------------------------------------------------ */
let characters = [
  {
    name: 'Eddard',
